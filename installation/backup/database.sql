...
--
-- Host: localhost:8889
-- Generation Time: Jun 16, 2026 at 10:18 AM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2026-06-16 10:16:42', NULL),
...
CREATE TABLE `ai_settings` (
  ...
  `customer_generate_limit` int(11) NOT NULL DEFAULT '0',
  `customer_image_upload_limit` int(11) NOT NULL DEFAULT '0',
...
(10, 'company_phone', '+8801000000000', NULL, '2020-12-08 14:15:01'),
...
(18, 'colors', '{\"primary\":\"#1b7fed\",\"secondary\":\"black\",\"primary_light\":\"#CFDFFB\"}', '2020-10-11 13:53:02', '2026-06-16 10:16:42'),
...
(49, 'social_login', '[{\"login_medium\":\"google\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1},{\"login_medium\":\"facebook\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1}]', NULL, '2026-06-16 10:16:42'),
...
(104, 'apple_login', '[{\"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1,\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}]', NULL, '2026-06-16 10:16:42'),
...
(176, 'firebase_otp_verification', '{\"status\":0,\"web_api_key\":\"\"}', '2024-09-24 07:52:17', '2026-06-16 10:16:42'),
...
(224, 'auction_feature_status', '0', '2026-06-16 10:16:42', '2026-06-16 10:16:42'),
(225, 'auction_commission_percentage', '0', '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(226, 'auction_entry_fee_amount_status', '0', '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(227, 'auction_entry_fee_amount_value', '0', '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(228, 'auction_expired_visibility_duration', '{\"status\":0,\"value\":0,\"unit\":\"day\"}', '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(229, 'auction_upcoming_visibility_duration', '{\"status\":0,\"value\":0,\"unit\":\"day\"}', '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(230, 'auction_winner_claim_time_limit', '{\"status\":0,\"value\":0,\"unit\":\"day\"}', '2026-06-16 10:16:43', '2026-06-16 10:16:43');
...
CREATE TABLE `categories` (
  ...
  `auction_home_status` tinyint(1) NOT NULL DEFAULT '0',
...
(1, '::1', NULL, '2026-06-16 10:16:49', '2026-06-16 10:16:49');
...
(373, '2026_03_29_140000_add_unique_index_to_seo_meta_info_table', 92),
(374, '2026_04_04_000001_add_customer_generate_limit_to_ai_settings_table', 92),
(375, '2026_04_04_120000_add_auction_home_status_to_categories_table', 92),
(376, '2026_04_16_100020_add_added_by_index_to_products_table', 92),
(377, '2026_04_28_000001_add_vendor_customer_status_to_withdrawal_methods_table', 92),
(378, '2026_05_05_000001_add_active_scope_indexes_to_products_sellers_brands_table', 92),
(379, '2026_05_07_152641_add_cm_firebase_token_web_to_users_table', 92),
(380, '2026_05_10_000001_add_cm_firebase_token_web_to_sellers_table', 92),
(381, '2026_05_17_120000_add_tax_for_column_to_tax_tables', 92),
(382, '2026_06_08_000001_add_customer_image_upload_limit_to_ai_settings_table', 92);
...
(7, 'customer', 'order_failed_message', 'Order fa Message', 0, '2023-10-30 11:02:55', '2026-06-16 10:16:42'),
...
(42, 'customer', 'auction_went_live', 'An auction you joined is now live', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(43, 'customer', 'auction_outbid', 'You have been outbid on an auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(44, 'customer', 'auction_won', 'Congratulations! You won an auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(45, 'customer', 'auction_participation_payment_verified', 'Your auction participation payment has been verified', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(46, 'customer', 'auction_claim_payment_verified', 'Your auction claim payment has been verified', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(47, 'customer', 'auction_commission_payment_verified', 'Your auction commission payment has been verified', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(48, 'customer', 'auction_delivery_ready', 'Your auction item is ready for delivery', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(49, 'customer', 'auction_delivery_on_the_way', 'Your auction item is on the way', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(50, 'customer', 'auction_delivered', 'Your auction item has been delivered', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(51, 'customer', 'auction_claim_expired', 'Your auction claim window has expired', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(52, 'customer', 'auction_next_bidder', 'You can now claim the auction item', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(53, 'customer', 'auction_approved', 'Your auction has been approved', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(54, 'customer', 'auction_denied', 'Your auction has been denied', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(55, 'customer', 'auction_expired_result', 'Your auction has ended', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(56, 'customer', 'auction_new_participation', 'A new participant has joined your auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(57, 'customer', 'auction_new_bid', 'A new bid has been placed on your auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(58, 'customer', 'auction_item_claimed', 'Your auction item has been claimed', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(59, 'customer', 'auction_claim_payment_verified_owner', 'The auction claim payment has been verified', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(60, 'customer', 'auction_withdrawal_approved', 'Your auction withdrawal has been approved', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(61, 'customer', 'auction_withdrawal_rejected', 'Your auction withdrawal has been rejected', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(62, 'seller', 'auction_approved', 'Your auction has been approved', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(63, 'seller', 'auction_denied', 'Your auction has been denied', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(64, 'seller', 'auction_expired_result', 'Your auction has ended', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(65, 'seller', 'auction_new_participation', 'A new participant has joined your auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(66, 'seller', 'auction_new_bid', 'A new bid has been placed on your auction', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(67, 'seller', 'auction_item_claimed', 'Your auction item has been claimed', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(68, 'seller', 'auction_claim_payment_verified_owner', 'The auction claim payment has been verified', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(69, 'seller', 'auction_withdrawal_approved', 'Your auction withdrawal has been approved', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43'),
(70, 'seller', 'auction_withdrawal_rejected', 'Your auction withdrawal has been rejected', 1, '2026-06-16 10:16:43', '2026-06-16 10:16:43');
...
CREATE TABLE `order_taxes` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tax_for` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'tax_for_orders'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sellers` (
  ...
  `cm_firebase_token_web` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `f_name`, `l_name`, `phone`, `image`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `street_address`, `country`, `city`, `zip`, `house_no`, `apartment_no`, `cm_firebase_token`, `cm_firebase_token_web`, `is_active`, `payment_card_last_four`, `payment_card_brand`, `payment_card_fawry_token`, `login_medium`, `social_id`, `is_phone_verified`, `temporary_token`, `is_email_verified`, `wallet_balance`, `loyalty_point`, `login_hit_count`, `is_temp_blocked`, `temp_block_time`, `referral_code`, `referred_by`, `app_language`) VALUES
(0, 'Walk-In Customer', 'Walk-In', 'Customer', '000000000000', 'def.png', 'walking@customer.com', NULL, '', NULL, NULL, '2026-06-16 10:16:42', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, 'en');
...
ALTER TABLE `digital_product_authors`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_dpa_author_product` (`author_id`,`product_id`);
...
ALTER TABLE `digital_product_publishing_houses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_dpph_house_product` (`publishing_house_id`,`product_id`);
...
ALTER TABLE `order_taxes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_taxes_tax_for_index` (`tax_for`);
...
ALTER TABLE `products`
  ...
  ADD KEY `idx_products_added_by` (`added_by`),
  ADD KEY `idx_products_type_status_request` (`product_type`,`status`,`request_status`),
...
ALTER TABLE `seo_meta_info`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `seo_meta_info_seoable_unique` (`seoable_type`,`seoable_id`);
...
ALTER TABLE `taxables`
  ADD PRIMARY KEY (`id`),
  ADD KEY `taxables_tax_for_index` (`tax_for`);
