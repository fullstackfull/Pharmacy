...
class SellerCenterCopySeeder extends Seeder
{
    ...
    private const COPY = [
        ...
        'n_hours' => [':count h', ':count ساعة'],
        'n_hours_n_minutes' => [':hours h :minutes min', ':hours ساعة و:minutes دقيقة'],
        'n_days' => [':count d', ':count يوم'],
        'n_days_n_hours' => [':days d :hours h', ':days يوم و:hours ساعة'],
