...
return [
	...
	"bulk_job_queued" => "Bulk job queued",
	"bulk_unknown_operation_type" => "Unknown bulk operation type",
	"bulk_reason_product_not_found" => "Product not found in your catalogue",
	"bulk_reason_unexpected_error" => "Unexpected error, this product was not changed",
	"bulk_reason_seller_no_longer_active" => "Shop is no longer active",
	"bulk_reason_permission_revoked" => "Permission was revoked before the job ran",
	"bulk_reason_price_would_be_zero_or_less" => "Price would become zero or less",
	"bulk_reason_discount_above_one_hundred_percent" => "Discount cannot exceed 100%",
	"bulk_reason_discount_not_below_price" => "Discount must be lower than the price",
	"bulk_reason_variant_stock_must_be_set_per_variant" => "Stock of a variant product must be set per variant",
	"bulk_reason_products_unavailable" => "Products are unavailable right now",
	...
	"insight_order_state_delivered_unpaid" => "Delivered but never paid for",
	"insight_order_state_canceled_paid" => "Cancelled while still paid",
	"insight_inventory_not_moving" => "Stock that has not moved",
	"insight_listing_live_without_stock" => "Live listings with no stock",
	"insight_listing_hidden_with_stock" => "Hidden listings that have stock",
	"insight_duplicate_barcodes" => "Two products share a barcode",
	"insight_missing_required_attributes" => "Listings missing required details",
	"insight_price_dropped_sharply" => "Price dropped sharply",
	"insight_price_rose_sharply" => "Price rose sharply",
	"insight_price_below_cost" => "Selling below cost",
	"insight_refund_response_overdue" => "Refund request needs an answer",
	"insight_returns_awaiting_processing" => "Returns waiting to be processed",
	"insight_shipments_not_moving" => "Shipments have stopped moving",
	"insight_delivered_without_earning" => "Delivered orders with no earning recorded",
	"notify_order_stuck" => "Orders have not moved",
	"notify_order_state" => "Orders contradict themselves",
	"notify_inventory_stale" => "Stock is not moving",
	"notify_catalog_integrity" => "Listings need fixing",
	"notify_pricing_risk" => "A price needs checking",
