                    ...
                    <table class="k-table">
                        ...
                        @foreach ($data as $key=>$item)
                            <tr>
                                ...
                                @php
                                    $isExpired = Carbon\Carbon::now()->greaterThan(Carbon\Carbon::parse($item->end_date_time));
                                @endphp
                                <td>
                                    <form action="{{route('admin.customer.wallet.bonus-setup-status')}}"
                                          method="post"
                                          id="bonus-setup-{{ $item->id }}-form"
                                          class="no-reload-form">
                                        @csrf
                                        <input name="id" value="{{$item['id']}}" hidden>
                                        <label class="switcher mx-auto"
                                               for="bonus-setup-{{ $item->id }}"
                                               @if($isExpired)
                                                   data-toggle="tooltip"
                                               data-placement="top"
                                               title="{{ translate('end_date_time_is_expired_update_the_end_time') }}"
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                data-on-image="{{dynamicAsset(path: 'public/assets/back-end/img/modal/bonus-turn-on.png')}}"
                                                data-off-image="{{dynamicAsset(path: 'public/assets/back-end/img/modal/bonus-turn-off.png')}}"
                                                data-on-title="{{translate('are_you_sure_to_turn_on_this_bonus_status').'?'}}"
                                                data-off-title="{{translate('are_you_sure_to_turn_off_this_bonus_status').'?'}}"
                                                data-on-message="<p>{{translate('when_you_turn_on_the_bonus,_customer_will_receive_this_bonus_&_enjoy_it').'.'}}</p>"
                                                data-off-message="<p>{{translate('when_you_turn_off_the_bonus,_this_bonus_offer_will_be_hidden_for_all_customer').'.'}}</p>"
