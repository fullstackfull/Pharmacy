...
@section('content')
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <h5>
                                    ...
                                    <span class="badge badge-soft-dark radius-50 fs-12 ms-1" id="withdraw-requests-count">{{ $withdrawRequests->total() }}</span>
                                </h5>
                            </div>
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex gap-3 justify-content-lg-end flex-xl-nowrap flex-wrap">
                                <div class="">
                                ...
                                <div class="dropdown">
                                    <a type="button" class="btn btn-outline--primary text-nowrap withdraw-export-btn"
                                       href="{{ route('vendor.delivery-man.withdraw.export', ['searchValue'=> request('searchValue') ?? '']) }}"
                                       data-base-url="{{ route('vendor.delivery-man.withdraw.export', ['searchValue'=> request('searchValue') ?? '']) }}"
                                    >
    ...
    <div class="withdraw-info-sidebar-wrap withdraw-details-view"></div>
@endsection
