...
@section('content')
    ...
    <span id="product-gallery-page" data-page="{{ request('product-gallery') ? 'product-gallery' : '' }}"></span>
@endsection
...
@push('script')
    ...
    <script>
        "use strict";
        $(document).on('click', '.remove-addition-image-for-product-gallery', function () {
