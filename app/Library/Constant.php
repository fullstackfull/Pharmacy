...
const GATEWAYS_PAYMENT_METHODS = [
    ...
    ['key' => 'paymera', 'value' => 'Paymera eGate'],
...
const CACHE_HOME_PAGE_AUCTION_PRODUCTS_LIST = 'cache_home_page_auction_products_list';

const CACHE_FOR_AUCTION_MAX_STARTING_PRICE = 'cache_for_auction_max_starting_price';
const CACHE_FOR_AUCTION_MIN_STARTING_PRICE = 'cache_for_auction_min_starting_price';
const CACHE_FOR_AUCTION_MAX_INCREMENT_AMOUNT = 'cache_for_auction_max_increment_amount';
const CACHE_FOR_AUCTION_MIN_INCREMENT_AMOUNT = 'cache_for_auction_min_increment_amount';
const CACHE_FOR_AUCTION_MAX_DECREMENT_AMOUNT = 'cache_for_auction_max_decrement_amount';
const CACHE_FOR_AUCTION_START_TIME_RANGE = 'cache_for_auction_start_time_range';
const CACHE_FOR_AUCTION_END_TIME_RANGE = 'cache_for_auction_end_time_range';
const CACHE_FOR_AUCTION_PRICE_RANGE = 'cache_for_auction_price_range';
const CACHE_FOR_AUCTION_ENDING_TIME_RANGE = 'cache_for_auction_ending_time_range';

const CACHE_PROVIDER_PUBLISHING_HOUSES_LIST = 'cache_provider_publishing_houses_list';
const CACHE_PROVIDER_PUBLISHING_HOUSES_COUNT = 'cache_provider_publishing_houses_count';
