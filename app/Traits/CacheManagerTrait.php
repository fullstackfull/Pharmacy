...
trait CacheManagerTrait
{
    ...
    {
        $homeCategories = Cache::remember(CACHE_HOME_CATEGORIES_LIST, CACHE_FOR_3_HOURS, function () {
        ...
        $homeCategories->each(function ($data) {
            $data['products'] = $data['products']?->take(10);
            $data->setRelation('product', $data['product']?->take(10));
        });
