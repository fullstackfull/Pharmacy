...
|---|---|---|
| سلايدر المنتجات | **طريقة العرض:** شريط أفقي بأسهم (rail) أو شبكة (grid) · المصدر: مميز/الأكثر مبيعاً/وصل حديثاً/الأعلى تقييماً/فئة/ماركة · عدد الأعمدة · زر «عرض الكل» | كتالوج المنتجات + أسعار وخصومات المتجر الفعلية |
...
| العرض السريع | **عدّاد تنازلي حيّ** حتى تاريخ انتهاء العرض الفعلي + زر «تسوّق العرض» | Promotion → Flash deals (لا عدّاد وهمي: بلا عرض جارٍ لا يظهر القسم إطلاقاً) |
